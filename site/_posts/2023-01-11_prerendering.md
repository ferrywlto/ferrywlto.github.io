...
[_blog/posts](https://github.com/NetCoreTemplates/vue-mjs/tree/main/ferrywlto.github.io/wwwroot/_blog/posts) whose content
is prerendered to: 
...
[Configure.Markdown.cs](https://github.com/NetCoreTemplates/vue-mjs/blob/main/ferrywlto.github.io/Configure.Markdown.cs),
...
[Post.cshtml](https://github.com/NetCoreTemplates/vue-mjs/blob/main/ferrywlto.github.io/Pages/Posts/Post.cshtml) Razor Page by populating its PageModel
...
[Posts/Index.cshtml](https://github.com/NetCoreTemplates/vue-mjs/blob/main/ferrywlto.github.io/Pages/Posts/Index.cshtml) Razor Page:
...
To ensure this is always run at deployment it's also added as an MS Build task in **ferrywlto.github.io.csproj**:
...
```yaml
 ...
 - name: Publish dotnet project
   working-directory: ./ferrywlto.github.io
   run: | 
