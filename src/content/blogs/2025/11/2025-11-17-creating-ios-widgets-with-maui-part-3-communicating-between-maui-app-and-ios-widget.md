...
![Adding App Groups](https://miro.medium.com/v2/resize:fit:1394/format:webp/1*56Qgu8TJwTM6YLVtsS33JA.png)

There will be a App Groups section shown at the bottom. Click the "+" button. 

![Add a new container](https://miro.medium.com/v2/resize:fit:902/format:webp/1*6PrnuTLENNdGEk3Vf1zCww.png)

Make sure your newly created App Group is checked.

![Enable app group](https://miro.medium.com/v2/resize:fit:1080/format:webp/1*O7fBaLLRLKDw8lsPuM-qHQ.jpeg)

4. **Do the same for the Xcode App project as well to make sure the provisioning profile managed by Xcode contains this entitlement.** Xcode will warns you if you forget to do this when you try to build build the MAUI app.
...
3. Open the MAUI project file to configure the same code sign entitlements as the Xcode App project did by adding the following PropertyGroup:
...
![Recording on widget communication with MAUI app](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*DToO7GrQzd4Qwxhd3cXl7Q.gif)
...
This post is originally published on [Medium](https://ferrywlto.medium.com/creating-ios-widgets-with-maui-part-3-communicating-between-maui-app-and-ios-widget-b177dd0e40a6).
